...
> **在浏览器工作的时候，偶尔有一些极其简单的需求需要AI帮助，比如简易问题（命令指南）和翻译等，如果新开网页会比较麻烦，不方便与当前工作做实时校对，如果是正在进行复杂任务的AI对话，简单问题也担心污染上下文，所以有这个悬浮窗AI需求；现有的AI悬浮窗，基本上都是开发者提供AI服务，且有限制，或者能力欠佳；所以我自行开发了这个能够适配 Coding Plan 的（截止开发当天，是没有适配我使用的 Coding Plan 的插件的），如果你有类似的需求，欢迎尝试并提出一些新的建议。**
...
miniQuestion 的定位是**主工具的补充**，而非替代。适合以下场景：
